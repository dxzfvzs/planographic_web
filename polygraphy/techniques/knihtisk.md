...
Mezi jeho ostatní vynálezy spojené s knihtiskem patří:

- **Litery**, jednotlivá písmenka, která bylo možné po seskládání rozebrat a znovu použít
- **Slévadlo** (forma) pro odlévání jednotlivých liter z matric
- **Písmovina** – slitina k odlévání liter – **olovo, cín, antimon**
- **Tisková barva** – zlepšil její složení, takže se dobře nanášela na kovové litery (saze, kobalt a olovo)
- **Tiskový stroj** – úpravou vinařského lisu pro potřeby tisku
...
neutvrzená místa se odplaví – odkryje se hliníková podložka, tedy netisknoucí místa.
...
Největší využití dnes stále nacházejí **příklopové knihtiskové stroje**, avšak ne pro samotný tisk, ale hrají doplňkovou roli.
Využívají se pro ražbu fólií nebo reliéfní ražbu (za tepla). Místo TF mohou být připnuty číslovače a číslovat tak ofsetem
vytisknuté tiskoviny. Také se může provádět výsek, perforace nebo rýhování.
