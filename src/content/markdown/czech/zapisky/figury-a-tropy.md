...
Umělecké jazykové prostředky, které oživují text. Dělí se na dvě skupiny: **tropy** – založené na **přenesení významu slov**, a **figury** – založené na **opakování, hromadění nebo zvláštním uspořádání slov** (význam se nemění).

---

## Tropy (přenesení významu)
...
## Figury (opakování a uspořádání slov)

### Zvukové figury

- **ALITERACE** – opakování stejných hlásek na začátcích po sobě jdoucích slov (*plachý papír plachtil pryč*).
- **ONOMATOPOIE (zvukomalba)** – hlásky/slova napodobují zvuk (*bum, řinčí, na topole podle skal zelený mužík zatleskal*).

### Opakování slov

- **ANAFORA** – opakování slova **na začátku** veršů/vět.
- **EPIFORA** – opakování slova **na konci** veršů/vět.
- **EPANASTROFA** – opakování slova **na konci jednoho a začátku dalšího** verše.
- **EPIZEUXIS** – opakování slova/sousloví **bezprostředně za sebou** v textu (*utíkej, utíkej!*).
...
- **GRADACE** – stupňování významu (*šel, běžel, letěl*).

---

## Jak je poznat u maturity
