...
- **mědiryt** – předchůdce hlubotisku, jedna z nejstarších tiskových technik, objevuje se už v 15. století
  – do měděné destičky se obraz ručně zahluboval rýdlem, destička se poté natřela barvou a otiskla na papír
- **heliogravura** – v 70. letech 19. století vynalezl Karel Klíč, je to technika přímého tisku z hloubky předchůdce
  klasického hlubotisku
...
1. **opracovávání ocelového jádra** – nanáší se tenká vrstva niklu (1–3 μm) proti korozi, udržuje pevnost Cu vrstvy
2. **mědění** – základní měděná vrstva (1–2 mm)
3. **zinkování** – pro vypalování tisknoucích míst
...
- Tisková barva je **řídké konzistence**, z barevníku je nanášena na povrch formového válce, přebytečná barva z povrchu
...
- **tisková jednotka** – barevník, formový válec, tlakový válec – ocel, vrstva pryže, stěrač – stírá barvu z netisk.
  míst
- **zařízení pro nastavené soutisku pomocí snímačů**
...
- **produkce**
    ...
    - časopisecké – potisk papíru
    - podle konstrukce
    - počet tiskových jednotek
    - podle formátu potiskovaného materiálu – úzkoformátové, širokoformátové
- **využití**
